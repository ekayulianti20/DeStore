...
class LaporanKasirAdminController extends Controller
{
    public function index()
    {
        return view('admin.laporan-kasir-admin');
    }
    ...
    public function json(Request $request)
    {
        ...
        \Log::info("TOTAL PENDAPATAN: $total_pendapatan, TOTAL MODAL: $total_modal, KEUNTUNGAN: $keuntungan");
